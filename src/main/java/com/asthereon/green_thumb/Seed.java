...
public enum Seed {
    ...
    KRONOS_SEED("Kronos seed","Anima - Speed",100,0,0,8,640,76,1,"","","Provides a chance for farming patches to skip a growth stage.","","","","","",""),
    IASOR_SEED("Iasor seed","Anima - Disease",100,0,0,8,640,76,1,"","","Decreases the chance of farming patches becoming diseased.","","","","","",""),
    ATTAS_SEED("Attas seed","Anima - Yield",100,0,0,8,640,76,1,"","","Increases the yield of farming patches.","","","","","",""),
